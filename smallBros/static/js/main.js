...
// setTimeout(() => {
//         document.getElementById('checkWallet').addEventListener('click', function() {
        ...
        (async () => {
            if(window.ethereum) {
                ...
                document.getElementById('mint').onclick = () => {
                    contract.methods.mintToken(1).send({ from: account, value: "200000000000000000"})
                }
            }
        })()
